...
class AddOnServicesAdapter(
    private val context: Context,
    private val discountList: List<Addon>,
    private val Cart_no: Int,
    private val addOnListner: AddOnListner
) : RecyclerView.Adapter<AddOnServicesAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int){
        val categorylist: Addon = discountList[position]
